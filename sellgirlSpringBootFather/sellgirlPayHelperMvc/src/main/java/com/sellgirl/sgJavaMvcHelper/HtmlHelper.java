...
//import com.sellgirl.sgJavaHelperMvc.*;
...
public class HtmlHelper {
	...
	public HtmlHelper(Map<String,Object> viewData) {
		ViewData=viewData;
	}
	//public List<String> CssPath=new ArrayList<String>();
//	public <TModel, TProperty> String TextBoxFor(Function<TModel, TProperty> expression,Map<String,Object> htmlAttributes) {
//		String name=expression.toString();
//		return SGDataHelper.FormatString("<input class=\"txt_333_12\" id=\"{0}\" name=\"{0}\" {1} type=\"text\" value=\"\">", ps);
//	}
...
//        return component.Html(htmlHelper, expression);
//    }
    public String BuildTextBox( String name, Object value, Consumer<PFTextBox> action)
    {
    	HtmlHelper htmlHelper=this;
    	PFTextBox component = new PFTextBox();
        component.SetPropertyFor(htmlHelper, name);
        if (action != null) { action.accept(component); }
...
//    public  MvcHtmlString BuildDropDownList( String name, Object value , Consumer<PFDropDownList> action)
//    {
//    	HtmlHelper htmlHelper=this;
//        var component = new PFDropDownList();
//        component.SetPropertyFor(htmlHelper, name);
...
//        return component.Html(htmlHelper, name, value);
//    }
//    public  String BuildDropDownList( String name, Object value , List<Pair<String,Object>> list)
//    {
//    	List<Pair<String, String>> cmonthList=null;
//    	BuildDropDownList(name,value,cmonthList);
//    	
//    	HtmlHelper htmlHelper=this;
//    	PFDropDownList component = new PFDropDownList();    	
//        component.SetPropertyFor(htmlHelper, name);
//        if (value != null) { component.SetSelectedValue(value.toString()); }
//        //if (action != null) { action(component); }
//        if (list != null) { component.SetSelectList(list); }
//        return component.Html(htmlHelper, name, value);
//    }
    public  String BuildDropDownList( String name, Object value , PFSelectList list)
    {
//    	List<Pair<String, String>> cmonthList=null;
//    	BuildDropDownList(name,value,cmonthList);
//    	
...
//    //#region Grid
    ...
    public String BuildGrid( List<?> data, SGAction<PFGrid,Object,Object> action)
    {
    	HtmlHelper htmlHelper=this;
    	PFGrid component = new PFGrid();
        component.SetModel(data);
        if (action != null) { action.go(component,null,null); }
        return component.Html(htmlHelper);
    }
    public String BuildGrid(List<?> data)
    {
    	return BuildGrid(data,null);
    }
    public String BuildGridForAllColumns(List<?> data)
    {
    	return BuildGrid(data,(a,b,c)->a.ColumnsForAll("yjquery"));
    }
    /**
     * thymelea模版里好像用不了委托lambda
     * @param data
     * @param modelConfig
     * @return
     */
    public String BuildGridForAllColumns(List<?> data,String modelConfig)
    {
    	return BuildGrid(data,(a,b,c)->a.ColumnsForAll(modelConfig));
    }
...
//        return component.Html(htmlHelper);
//    }
    public  String BuildGrid(SGDataTable data, SGAction<PFGrid,Object,Object> action
    		)
    {
    	HtmlHelper htmlHelper=this;
    	PFGrid component = new PFGrid();
...
//        return component.Html(htmlHelper, expression);
//    }
    public MvcHtmlString BuildLabel( String expression, Consumer<PFLabel> action )
    {
    	HtmlHelper htmlHelper=this;
    	PFLabel component = new PFLabel();
        component.SetPropertyFor(htmlHelper, expression);
        if (action != null) { action.accept(component); }
        return component.Html(htmlHelper, expression);
    }
    public String Hidden( String expression, Object value)//, Consumer<PFHiddenBox> action )
    {
    	//String s=SGDataHelper.FormatString("<input type=\"hidden\" value=\"\" />", ps)
    	HtmlHelper htmlHelper=this;
    	PFHiddenBox component = new PFHiddenBox();
        component.SetPropertyFor(htmlHelper, expression);
        //if (action != null) { action.accept(component); }
        return component.Html(htmlHelper, expression,value);
    }
//
//    //#endregion
//    //#region FileUpload
