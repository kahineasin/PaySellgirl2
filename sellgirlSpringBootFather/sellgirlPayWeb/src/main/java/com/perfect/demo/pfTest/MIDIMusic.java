...
public class MIDIMusic extends com.sellgirl.sgJavaHelper.midi.MIDIMusic {
...
//            }
//            int [] type = MidiSystem.getMidiFileTypes(seq);
//            MidiSystem.write(seq,type[0],new java.io.File("Òô½Ú.midi"));//±£´æmidiÒôÀÖ
//            Sequencer player = MidiSystem.getSequencer(); //¶¨ÐòÆ÷£¬¸ºÔð²¥·ÅÒô·ûÐòÁÐ
//            player.open();
//            player.setSequence(seq);   //¸ºÔð²¥·ÅÒô·ûÐòÁÐ
...
//        MidiSystem.write(seq,type[0],new java.io.File(path));//±£´æmidiÒôÀÖ
//        Sequencer player = MidiSystem.getSequencer(); //¶¨ÐòÆ÷£¬¸ºÔð²¥·ÅÒô·ûÐòÁÐ
//        player.open();
//        player.setSequence(seq);   //¸ºÔð²¥·ÅÒô·ûÐòÁÐ
//        //player.setLoopCount(1);    //
