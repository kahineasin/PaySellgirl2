...
public class QuickNotePlayer extends com.sellgirl.sgJavaHelper.midi.QuickNotePlayer {
...
//        player.noteOff(60);
        ...
        player.downX(new int[] {5,-1,1});
        Thread.sleep(500); // 让声音持续1秒
        player.upX(new int[] {5,-1,1});

        player.downX(new int[] {1,1,1});
        Thread.sleep(1000); // 让声音持续1秒
        player.upX(new int[] {1,1,1});
