...
//
///**
// * 测试嵌套JarFile,首先用file读父,最后一层才用jarFile读,这样读不了
// */
...
////            urls.add(new URL("jar:file:/D:/eclipse_release/javaDemo4/javaDemo4-0.0.1-jar-with-dependencies.jar!/jar/mysql-connector-java-8.0.23.jar!/"));
////            PFURLClassLoader ucl = new PFURLClassLoader(urls.toArray(new URL[urls.size()]));
////            Class<?> cls=ucl.loadClass("com.mysql.cj.jdbc.Driver");
////
////            if(null == cls) {
////                LOGGER.info("Class" + 1 + " is null");
////            }else {
...
//
////        //ZipEntry entry=jf5.getJarEntry("/jar/mysql-connector-java-8.0.23.jar");
//        JarEntry entry=jf5.getJarEntry("mysql-connector-java-8.0.23.jar");//is not null
//        if(null == entry) {
//            LOGGER.info("entry" + 1 + " is null");
//        }else {
//            LOGGER.info("entry" + 1 + " is not null");
//            ArrayList<URL> urls = new ArrayList<URL>();
//            //urls.add(new URL("D:/eclipse_release/javaDemo4/javaDemo4-0.0.1-jar-with-dependencies.jar"));//Exception in thread "main" java.net.MalformedURLException: unknown protocol: d
//            urls.add(new URL("jar:file:/jar/mysql-connector-java-8.0.23.jar!/"));
//            //PFURLClassLoader ucl = new PFURLClassLoader(urls.toArray(new URL[urls.size()]));
//            //Class<?> cls=ucl.loadClass("com.mysql.cj.jdbc.Driver");
//
//
//            AccessControlContext acc = AccessController.getContext();
//            URLClassPath ucp = new URLClassPath(urls.toArray(new URL[urls.size()]), acc); //可以模仿这样构造
//            Resource rs=ucp.getResource("com.mysql.cj.jdbc.Driver");
//
//            if(null == rs) {
//                LOGGER.info("Resource" + 1 + " is null");
//            }else {
//                LOGGER.info("Resource" + 1 + " is not null");
//            }
//        }
//	}
//
