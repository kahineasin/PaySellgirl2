...
@Component
public class CrystalOfAtlan implements ISwitchPadSetting{
	...
	public GamePadCustomAction[] getR() {
		return new GamePadCustomAction[] {new GamePadCustomAction("宠物技能")};
	}
	...
	public GamePadCustomAction[] getLS() {
		return new GamePadCustomAction[] {new GamePadCustomAction(GamePadAction.爆气 )};
	}
