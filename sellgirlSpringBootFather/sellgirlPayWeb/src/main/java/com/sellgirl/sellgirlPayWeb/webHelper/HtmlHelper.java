package com.sellgirl.sellgirlPayWeb.webHelper;

import java.util.Map;
import java.util.function.Consumer;
import pf.java.pfHelper.mvc.*;
...
//		return PFDataHelper.FormatString("<input class=\"txt_333_12\" id=\"{0}\" name=\"{0}\" {1} type=\"text\" value=\"\">", ps);
//	}
