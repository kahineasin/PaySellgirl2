...
@Component
public class DeltaForce2 implements ISwitchPadSetting{
	...
	public GamePadCustomAction[] getR() {
		return new GamePadCustomAction[] {new GamePadCustomAction(GamePadAction.快捷菜单),new GamePadCustomAction(GamePadAction.右探头)};
	}
	...
	public GamePadCustomAction[] getDOWN() {
		return new GamePadCustomAction[] {new GamePadCustomAction(GamePadAction.补充弹药),new GamePadCustomAction(GamePadAction.交互),new GamePadCustomAction(GamePadAction.B5)};
	}

	@Override
	public GamePadCustomAction[] getLEFT() {
		return new GamePadCustomAction[] {new GamePadCustomAction(GamePadAction.B7)};
	}
	...
	public GamePadCustomAction[] getRS() {
		return new GamePadCustomAction[] {new GamePadCustomAction(GamePadAction.切换瞄准镜)};
	}
