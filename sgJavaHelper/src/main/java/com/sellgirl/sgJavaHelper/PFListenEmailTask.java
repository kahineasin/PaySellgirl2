...
/// <summary>
/// 监听邮件的任务
/// 改用PFListenNewEmailTask
/// </summary>
@Deprecated
public class PFListenEmailTask implements IPFTask//, IDisposable
{
...
//                    }
                    ...
                    {
                        newestMailTime = null;
                        SGDataHelper.WriteError(new Exception(SGDataHelper.FormatString("SubjectMatch报错{0}", e)));
                    }
                    if (b)
                    {
                        try
...
//                	PFDataHelper.FormatString("PFListenEmailTask 537行 step:{0}\r\n",String.valueOf(step)),e) );
                SGDataHelper.WriteError(new Throwable(),new Exception(
                    	SGDataHelper.FormatString("PFListenEmailTask 537行 step:{0}\r\n error:{1}",String.valueOf(step),e))  );
                try {
					Thread.sleep(SGDataHelper.CheckMessageInterval());
