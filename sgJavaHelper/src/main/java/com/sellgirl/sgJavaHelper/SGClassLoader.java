...
/**
 * 此类之前的版本没有close 新的 URLClassLoader，似乎不好
 * @deprecated 改用 SGClassLoader2
 */
@Deprecated
public class SGClassLoader {
...
//	public static HashMap<String,URLClassLoader[]> uclMap=null;
//	private static HashMap<String,URLClassLoader> uclMap2=null;
	 ...
	 * @throws Exception
	 */
	public static Class<?> doLoadClass(String jarPath, String className,SGRef<Integer> tryStepRef) throws Exception {
		Class<?> dClass = null;
...
//		}else {
		...
		URL u3 = null;
		try {
		u3=SGClassLoader.class.getResource(Paths.get("jar", jarPath).toString());
		}catch(Exception e) {}
...
//		}
		...
		URLClassLoader ucl2 = new URLClassLoader(urlArr,SGClassLoader.class.getClassLoader());
...
//    	String jarName="D:/cache/knightsashax.jar";
		...
		Class<?> c1=null;
		try {
			c1 = SGClassLoader.doLoadClass(jarName, "com.sellgirl.knightsashax.GameXScreen", i);
