...
@Deprecated
public class PFDayTask
//extends PFTimeTaskBase<PFDayTask>
extends PFDayTaskBase<PFDayTask>
...
////    private String finishedMsg="";
     ...
     */
    public PFDayTask(String hashId, PFFunc3<String, SGDate, PFDayTask,Boolean> doAction, int backupHour, int backupMinute,boolean jumpThePassedTask,TaskFollower[] follower)
    {
