...
public class PFMonthTaskBase2<TTask>
...
//    private String finishedMsg="";
     ...
     */
    public PFMonthTaskBase2(String hashId, PFFunc3<SGDate, SGDate, TTask,Boolean> doAction, int backupDay,int backupHour, int backupMinute,boolean jumpThePassedTask,TaskFollower[] follower)
    {
...
//
        ...
        init(hashId,doAction,
        		backupDay, backupHour,  backupMinute,-1,
