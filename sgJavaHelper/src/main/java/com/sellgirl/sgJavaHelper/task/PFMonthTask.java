...
@Deprecated
public class PFMonthTask//<TUserData> 
//extends PFTimeTaskBase<PFMonthTask>
extends PFMonthTaskBase<PFMonthTask>
//	 implements IPFTimeTask
	    {
	        ...
	        /// 参数执行的月份
	        /// </summary>
	        //public PFAction<String, PFMonthTask,Object> DoPFAction =null;
//	        /// <summary>
//	        /// 可以执行的条件
//	        /// </summary>
//	        public PFFunc<String, PFMonthTask<TUserData>,Object, Boolean> CanDoPFAction =null;
...
//	        }
//	        public PFMonthTask(String hashId, 
////	        		PFAction<String, PFMonthTask,Object> doPFAction,
//	        		PFFunc<String,PFDate, PFMonthTask,Boolean> doAction, 
//	        		//PFFunc<String, PFMonthTask<TUserData>,Object, Boolean> canDoPFAction, 
...
//	        }
	         ...
	         */
	        public PFMonthTask(String hashId, PFFunc3<String, SGDate, PFMonthTask,Boolean> doAction,int backupDay, int backupHour, int backupMinute,boolean jumpThePassedTask,TaskFollower[] follower)
	        {
//	        	//super(hashId,doAction);
//	        	
//	            //HashId = hashId;
