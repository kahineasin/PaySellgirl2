...
//        
// *  HttpRequestBase已经过期,下次使用SGHttpHelper顺别把方式改了.注意proguard压缩后.运行时只要类中接触此类都会报错HttpRequestBase不存在,因为当前时provided的
// */
////@Deprecated
//public class SGHttpHelper2 {
//	// #endregion String
//		public static <RequestType extends HttpUriRequestBase> SGRequestResult HttpRequest(RequestType httpRequest, String url,
...
//				SGRequestResult r2 = SGHttpHelper2.HttpGet(url, "");
