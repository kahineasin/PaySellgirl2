...
public class Test002 extends TestCase {
	...
	private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(Test002.class);
	 ...
	 */
	public Test002(String testName) {
		super(testName);
	}
	...
	public static Test suite() {
		return new TestSuite(Test002.class);
	}
